...
- \usepackage{wrapfig}
- \pagestyle{fancy}
- \fancyhead[LE,RO]{Christen, Goffeney, Vermeil, Vigu?fÃ,Â©}
fontsize: 12pt
...
```{r, echo=FALSE, message=FALSE, include=FALSE}
hg.form.step2 = TotHg ~ fisherman + fisherman:(age + restime + height + weight + fishmlwk + fishpart) - 1
...
The best model is now : TotHg ~ fisherman + fisherman:weight + fisherman:fishmlwk - 1.
