...
```{r echo = F, warning = F, message = F, fig.width=3.5, fig.height = 3, fig.cap = "Diagnostic plots", fig.subcap=c("\\label{fig:residuals}residuals", "\\label{fig:QQ}QQ-plot"), fig.pos= "htbp", out.height="7cm", out.width=".45\\linewidth", fig.align="center"}
library(ggplot2)
